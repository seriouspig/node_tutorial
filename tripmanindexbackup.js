...
const tripManager = {
    ...
    api: {
        ...
        getFlightInfo: (req, res) => {       
            console.log('first')     
            // res.json(getFlightData())
            // return res.json("Full result: " + flightDetails)
            ...
            console.log('second')
            // return res.json(wowboxGetRequest(wowboxApiConfig.endpoint.flightInfo))
